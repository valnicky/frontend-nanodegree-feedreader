...
$(function() {
    ...
    */
    ...
    /* We write a new test suite named "The menu" */
     ...
     /* this tests ensures the menu changes
          * visibility when the menu icon is clicked, if the menu display when
    ...
    /* We write a new test suite named "Initial Entries" */
 ...
 /* We write a new test suite named "New Feed Selection" */
